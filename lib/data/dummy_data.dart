...
const DUMMY_MEALS = [
  ...
  Meal(
    ...
    steps: [
      'Wash, cut the onions and garlic',
      'Wash whole chicken',
      'Mix all seasonings',
      'Stuff all seasonings inside the chicken',
      'Prepare the rolling grill',
      'Keep the chicken rolling on the grill for about an hour',
      'Serve the pinoy style Lechon Manok'
    ],
    isGlutenFree: true,
    isVegan: true,
    isVegetarian: false,
  ...
  Meal(
    ...
    steps: [
      ...
      'Suggested Pairing Fruit-forward Grenache.',
    ],
    isGlutenFree: true,
    isVegan: true,
    isVegetarian: false,
